...
const DragDrop2 = () => {
    ...
    return (
        <div className="p-4 max-w-4xl mx-auto bg-gray-800 text-white rounded-xl shadow-md my-6"> {/* Updated background to dark */}
            ...
            <div
                ...
                onDrop={onDrop}
                className='text-xl mt-10 line-height-10 h-[500px] w-full overflow-auto'
                placeholder="Drop code snippets here..."
                style={{ backgroundColor: '#1e1e1e', color: '#ffffff', padding: '10px', borderRadius: '5px' }} // Dark background for editor
            >
