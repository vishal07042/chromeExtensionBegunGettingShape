...
const DragDropQuestion = ({ question, items, onComplete, onNext }) => {
    ...
    const onDrop = (e, dropIndex) => {
        ...
        setIsCorrect(null); // Reset isCorrect to allow re-checking
    };

    const showCorrectAnswer = () => {
        console.log("Correct Answer:", question.correctOrder);
    };
    ...
    return (
        <div className="mb-4 border p-4 rounded-md shadow-sm">
            ...
            <div className="mt-4 flex items-center">
                <button onClick={() => { checkAnswer(); showCorrectAnswer(); }} className="mr-2 bg-blue-500 text-white py-2 px-4 rounded">
                    Check Answer
                </button>
